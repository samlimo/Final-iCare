...
public class DoctorList extends ListActivity {
	...
	private void createNote() {
		Intent i = new Intent(this, DoctorEdit.class);
	...
	protected void onListItemClick(ListView l, View v, int position, long id) {
		...
		Intent i = new Intent(this, DoctorEdit.class);
		i.putExtra(DoctorDbAdapter.KEY_ROWID, id);
	...
	private void fillData() {
		...
		String[] from = new String[] { DoctorDbAdapter.KEY_TITLE,
				DoctorDbAdapter.KEY_DATE };
		int[] to = new int[] { R.id.text1, R.id.date_row };

		// Now create an array adapter and set it to display using our row
		SimpleCursorAdapter notes = new SimpleCursorAdapter(this,
				R.layout.doctor_row, notesCursor, from, to);
