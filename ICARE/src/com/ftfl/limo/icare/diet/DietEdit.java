...
public class DietEdit extends Activity{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mRowId = (savedInstanceState == null) ? null :
            (Long) savedInstanceState.getSerializable(DietDbAdapter.KEY_ROWID);
        if (mRowId == null) {
            Bundle extras = getIntent().getExtras();
            mRowId = extras != null ? extras.getLong(DietDbAdapter.KEY_ROWID)
                                    : null;
        }
	  ...
	  @Override
	    protected void onSaveInstanceState(Bundle outState) {
	        ...
	        saveState();
	        outState.putSerializable(DietDbAdapter.KEY_ROWID, mRowId);
	    }
		...
		public boolean onOptionsItemSelected(MenuItem item) {
		    ...
		    case R.id.menu_about:
		        ...
		        AlertDialog.Builder dialog = new AlertDialog.Builder(DietEdit.this);
	    ...
	    private void populateFields() {
	        if (mRowId != null) {
	            ...
	            mTitleText.setText(note.getString(
	    	            note.getColumnIndexOrThrow(DietDbAdapter.KEY_TITLE)));
	            mBodyText.setText(note.getString(
	                    note.getColumnIndexOrThrow(DietDbAdapter.KEY_BODY)));
