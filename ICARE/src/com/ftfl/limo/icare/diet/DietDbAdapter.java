...
public class DietDbAdapter {
    ...
    private static final String TAG = "DietDbAdapter";
    ...
    private static final String DATABASE_NAME = "icarediet";
     ...
     */
    public DietDbAdapter(Context ctx) {
        this.mCtx = ctx;
    }
     ...
     */
    public DietDbAdapter open() throws SQLException {
