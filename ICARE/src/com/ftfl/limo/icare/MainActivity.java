...
import com.ftfl.limo.icare.adapter.NavDrawerListAdapter;
...
import com.ftfl.limo.icare.fragment.HomeFragment;
import com.ftfl.limo.icare.model.NavDrawerItem;
...
public class MainActivity extends Activity {
	...
	public boolean onPrepareOptionsMenu(Menu menu) {
		...
		menu.findItem(R.id.notes).setVisible(!drawerOpen);
		menu.findItem(R.id.diet).setVisible(!drawerOpen);
