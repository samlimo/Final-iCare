...
public class VaccineDbAdapter {
    ...
    private static final String TAG = "VaccineDbAdapter";
    ...
    private static final String DATABASE_NAME = "icarevaccine";
     ...
     */
    public VaccineDbAdapter(Context ctx) {
        this.mCtx = ctx;
    }
     ...
     */
    public VaccineDbAdapter open() throws SQLException {
