...
public class VaccineEdit extends Activity{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mRowId = (savedInstanceState == null) ? null :
            (Long) savedInstanceState.getSerializable(VaccineDbAdapter.KEY_ROWID);
        if (mRowId == null) {
            Bundle extras = getIntent().getExtras();
            mRowId = extras != null ? extras.getLong(VaccineDbAdapter.KEY_ROWID)
                                    : null;
        }
	  ...
	  @Override
	    protected void onSaveInstanceState(Bundle outState) {
	        ...
	        saveState();
	        outState.putSerializable(VaccineDbAdapter.KEY_ROWID, mRowId);
	    }
		...
		public boolean onOptionsItemSelected(MenuItem item) {
		    ...
		    case R.id.menu_about:
		        ...
		        AlertDialog.Builder dialog = new AlertDialog.Builder(VaccineEdit.this);
	    ...
	    private void populateFields() {
	        if (mRowId != null) {
	            ...
	            mTitleText.setText(note.getString(
	    	            note.getColumnIndexOrThrow(VaccineDbAdapter.KEY_TITLE)));
	            mBodyText.setText(note.getString(
	                    note.getColumnIndexOrThrow(VaccineDbAdapter.KEY_BODY)));
